        ...
        papers: [
          {
            ...
            intro_cn:
              '关联研究内容指标1.1“数据驱动的因果网络可识别理论”、指标1.2“跨媒体数据的因果网络构建算法”，针对传统方法容易陷入局部最优、且缺乏隐混淆可识别性理论的问题，利用高阶累积量揭示隐变量与观测变量之间的内在联系，建立了具有解析解、可检验的隐混淆因果发现理论与方法。',
            date: '2023/7/23',
            status: 'Published',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标1.1“数据驱动的因果网络可识别理论”、指标1.2“跨媒体数据的因果网络构建算法”，针对含隐变量场景下因果方向难以识别的问题，提出了基于高阶累积量的因果结构识别方法，给出了因果系数及其比值的解析估计，并实现因果边与方向的有效检测。',
            date: '2024/3/24',
            status: 'Published',
            status_color: 'success',
            imgUrl: 'learn1-2.png',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标1.1“数据驱动的因果网络可识别理论”，针对离散数据的隐表征因果结构识别理论缺失问题，揭示了隐表征与概率张量秩的内在联系，提出基于张量秩分解理论的因果表征学习识别方法，破解了离散数据隐因果表征识别难题。',
            date: '2024/9/26',
            status: 'Accepted',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标1.2“跨媒体数据的因果网络构建算法”，针对传统方法依赖先验分布假设、难以准确推断隐表征间因果关系的问题，提出了隐因果表征间的条件独立性检验方法，破解了隐因果表征间的因果方向识别难题。',
            date: '2024/2/28',
            status: 'Published',
            status_color: 'success',
            imgUrl: 'learn1-5.png',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标1.1“数据驱动的因果网络可识别理论”、指标1.2“跨媒体数据的因果网络构建算法”，针对现有因果推理方法依赖无自屏蔽假设的问题，提出了基于加性噪声模型扩展可识别性范围的方法，给出了因果方向充要条件并设计了相应的因果发现算法。',
            date: '2024/3/24',
            status: 'Published',
            status_color: 'success',
            imgUrl: 'learn1-6.png',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标1.1“数据驱动的因果网络可识别理论”、指标1.2“跨媒体数据的因果网络构建算法”，针对跨媒体数据中个体因果结构学习受限于单一个体样本量不足、难以有效利用群体共享信息的问题，提出了基于个体线性无环模型和共享独立成分分析技术的个体因果结构学习方法。',
            date: '2024/4/17',
            status: 'Published',
            status_color: 'success',
            imgUrl: 'learn1-7.png',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标1.2“跨媒体数据的因果网络构建算法”，针对传统方法结构假设强、受限于树等特定层次结构的问题，提出了更加一般化条件下的分层因果网络学习方法，突破了现有分层因果网络的“树状”约束和非高斯假设。',
            date: '2023/8/25',
            status: 'Published',
            status_color: 'success',
            imgUrl: 'learn1-8.png',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标1.1“数据驱动的因果网络可识别理论”、指标1.2“跨媒体数据的因果网络构建算法”，针对外部干预导致时序因果发现方法出现虚假因果关系的问题，提出了一种面向外部干扰场景的时序隐变量结构因果模型学习方法。',
            date: '',
            status: 'Published',
            status_color: 'success',
            imgUrl: 'learn1-9.png',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标1.2“跨媒体数据的因果网络构建算法”，针对传统因果方法在高方差变量数据场景下容易失效的问题，提出了基于增强条件独立性检验与启发式搜索的鲁棒因果发现算法，实现了高方差变量场景下因果结构的稳定学习。',
            date: '2024/12/26',
            status: 'Published',
            status_color: 'success',
        ...
        patents: [
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容1.2“跨媒体数据的因果网络构建算法”，提出了基于可识别变分自编码器的因果表征知识追踪方法，提高了知识追踪效果。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
          },
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容1.2“跨媒体数据的因果网络构建算法”，提出了一种面向智能制造的因果驱动生产系统建模与无偏策略优化方法，实现精准的因果发现。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
          },
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容1.2“跨媒体数据的因果网络构建算法”，提出了一种面向无线网络性能指标的因果发现方法及系统，为网络故障检测提供根因分析指导。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
        ...
        papers: [
          {
            ...
            intro_cn:
              '关联研究内容指标2.1“融合知识、数据和行为的因果效应可识别理论”，针对网络效应估计方法依赖模型假设、容易出现模型错指的问题，提出了基于目标学习的双重稳健网络效应估计方法。',
            date: '2024/5/2',
            status: 'Published',
            status_color: 'success',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标2.2“基于因果效应的因果推理及反事实推理算法”，针对现有表因果效应估计方法高度依赖具体度量的问题，提出了基于最优传输的表征平衡方法，实现不依赖分布假设的因果效应估计。',
            date: '2024/5/2',
            status: 'Published',
            status_color: 'success',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标1.1“数据驱动的因果网络可识别理论”、指标1.2“跨媒体数据的因果网络构建算法”，针对传统计数数据方法可识别性受限的问题，提出了计数数据因果方向可识别性的充要条件和基于高阶累积量的因果结构方法，破解了计数数据的因果结构识别难题。',
            date: '2024/9/26',
            status: 'Accepted',
            status_color: 'primary',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标2.1“融合知识、数据和行为的因果效应可识别理论”、指标2.2“基于因果效应的因果推理及反事实推理算法”，针对长期异质因果效应估计中存在的隐混淆问题，提出了基于可识别因果表征学习的隐混淆恢复方法，实现长期异质效应估计。',
            date: '2025/4/28',
            status: 'Accepted',
            status_color: 'primary',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标2.1“融合知识、数据和行为的因果效应可识别理论”，针对离散时间事件序列中因果结构学习受限于传统格兰杰因果假设的问题，提出了结构霍克斯过程模型，利用瞬时效应实现离散时间事件序列中的因果结构识别。',
            date: '2023/8/25',
            status: 'Published',
            status_color: 'success',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标2.1“融合知识、数据和行为的因果效应可识别理论”、指标2.2“基于因果效应的因果推理及反事实推理算法”，针对长期因果效应估计中的短期高维变量因果结构未知且含隐变量的问题，提出了基于可识别因果表征的短期隐变量恢复理论用于长期效应估计。',
            date: '2024/4/23',
            status: 'Published',
            status_color: 'success',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标2.2“基于因果效应的因果推理及反事实推理算法”，针对现有因果效应估计方法在复杂场景下协变量分布对齐困难、导致效应估计不准的问题，提出了基于最优传输理论的组间协变量对齐方法，实现因果效应的高精度估计。',
            date: '2024/3/24',
            status: 'Published',
            status_color: 'success',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标2.1“融合知识、数据和行为的因果效应可识别理论”、指标2.2“基于因果效应的因果推理及反事实推理算法”，针对现有基于霍克斯过程的格兰杰因果发现方法因假设平稳性而在非平稳事件序列中表现不佳的问题，提出了StateHPs模型，通过统一建模不同状态下的生成过程，实现非平稳事件序列中的格兰杰因果图准确识别。',
            date: '',
            status: 'Published',
            status_color: 'success',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标1.1“数据驱动的因果网络可识别理论”、指标1.2“跨媒体数据的因果网络构建算法”，针对传统方法在计数数据上局部结构因果关系不可识别的问题，揭示了路径信息与高阶累积量之间的内在联系，提出了基于路径分析的计数数据因果结构学习方法。',
            date: '2024/3/24',
            status: 'Published',
            status_color: 'success',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标2.1“融合知识、数据和行为的因果效应可识别理论”，针对事件序列存在非独立同分布特性、导致传统格兰杰因果发现方法难以直接应用的问题，提出了拓扑神经泊松自回归模型TNPAR，实现事件序列生成过程与推理过程的一体化建模。',
            date: '2024/3/24',
            status: 'Published',
            status_color: 'success',
        ...
        patents: [
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容2.2“基于因果效应的因果推理及反事实推理算法”，提出了基于分布渐进迁移的因果推断模型调整方法，提高了因果效应估计的准确性。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
          },
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容2.2“基于因果效应的因果推理及反事实推理算法”，提出了一种基于最优传输的因果效应估计方法，解决了混淆偏差导致因果估计不准的问题。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
          },
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容2.2“基于因果效应的因果推理及反事实推理算法”，提出了基于时序混淆偏差的营销定价因果效应估计方法，解决了长期因果效应估计不准的问题。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
          },
          {
            ...
            abstract: '',
            intro_cn: '关联研究内容2.2“基于因果效应的因果推理及反事实推理算法”，实现了代价最小的网络故障检测根因分析。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
        ...
        papers: [
          {
            ...
            intro_cn:
              '关联研究内容指标3.1“融合环境、动作和激励的强化学习因果模型及其泛化性理论”、指标3.2“基于因果效应的强化学习策略优化与评估方法”，针对传统强化学习存在决策空间庞大、采样效率低、泛化性与可解释性不足的问题，提出了一种融合环境因果结构、动作干预与奖励机制的在线因果强化学习框架，并给出了因果结构可识别性与策略收敛性的理论保证。',
            date: '2025/4/24',
            status: 'Accepted',
            status_color: 'primary',
            imgUrl: 'learn2-1.png',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容3.1“融合环境、动作和激励的强化学习因果模型及其泛化性理论”、3.2“基于因果效应的强化学习策略优化与评估方法”，针对大语言模型在复杂决策任务中推理能力不足、环境适应性差的问题，提出了融合结构因果模型的因果感知大语言模型框架，通过“学习—适应—行动”范式动态建模并更新环境因果知识，从而提升策略制定效率与决策准确性。',
            date: '2025/4/28',
            status: 'Accepted',
            status_color: 'primary',
            imgUrl: 'learn2-2.png',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容3.1“融合环境、动作和激励的强化学习因果模型及其泛化性理论”、3.2“基于因果效应的强化学习策略优化与评估方法”，针对无人机在未知场景中视觉表征包含大量非因果因素、导致深度强化学习策略泛化能力不足的问题，提出了因果表征解耦方法，通过分离视觉中的因果与非因果成分来减少伪相关干扰，提升未知环境下的避障鲁棒性与泛化性能。',
            date: '2024/12/20',
            status: 'Published',
            status_color: 'success',
            imgUrl: 'learn2-3.png',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容4.1“因果机器学习的泛化性理论”、4.2“基于因果关联评价及可解释性框架、基于因果表征的迁移学习方法”，针对路面裂缝自动检测中模型计算复杂度高、难以在资源受限嵌入式设备上实时部署的挑战，提出了一种轻量级编码器—解码器网络RHACrackNet，在显著降低参数量和计算开销的同时实现了高精度、高速度的像素级裂缝检测。',
            date: '2023/8/18',
            status: 'Published',
            status_color: 'success',
            imgUrl: 'learn2-5.png',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容3.1“融合环境、动作和激励的强化学习因果模型及其泛化性理论”、3.2“基于因果效应的强化学习策略优化与评估方法”，针对深度强化学习在未知场景中泛化能力不足的问题，提出了基于因果特征选择的多无人机避撞稳健策略学习方法，从视觉表征中识别并过滤非因果因素，减少虚假相关对策略学习的影响。',
            date: '2024/12/20',
            status: 'Published',
            status_color: 'success',
            imgUrl: 'learn2-9.png',
        ...
        patents: [
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容3.1“融合环境、动作和激励的强化学习因果模型及其泛化性理论”、3.2“基于因果效应的强化学习策略优化与评估方法”，提出了一种基于因果表征学习的磁芯损耗预测方法，通过分离与损耗机理相关的稳定因果因素和环境扰动因素，提高复杂工况下磁芯损耗预测的精度、稳健性与跨场景泛化能力。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
          },
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容3.1“融合环境、动作和激励的强化学习因果模型及其泛化性理论”、3.2“基于因果效应的强化学习策略优化与评估方法”，提出了动态环境下基于因果强化学习的序列决策方法，通过显式建模状态生成机制与动作干预影响，提升动态场景中的决策质量、样本效率与策略泛化能力。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
          },
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容3.1“融合环境、动作和激励的强化学习因果模型及其泛化性理论”、3.2“基于因果效应的强化学习策略优化与评估方法”，提出了一种基于因果反事实的带延迟反馈上下文老虎机推荐方法，通过对延迟反馈下的数据生成过程进行因果建模并估计反事实奖励，缓解选择偏差问题，提升在线推荐策略的稳定性与效果。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
          },
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容3.1“融合环境、动作和激励的强化学习因果模型及其泛化性理论”、3.2“基于因果效应的强化学习策略优化与评估方法”，提出了一种结合因果模型和深度强化学习的多智能体避障方法及系统，解决了传统视觉导航泛化性差的难题。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
      ...
      },
      {
        ...
        papers: [
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标4.1“因果机器学习的泛化性理论”、指标4.2“基于因果关联评价及可解释性框架、基于因果表征的迁移学习方法”，针对时间序列预测中的跨域条件分布变化与复杂时滞依赖问题，提出了基于因果条件偏移假设的可迁移时间序列预测方法，通过学习跨域稳定的Granger因果结构提升目标域预测精度与可解释性。',
            date: '2023/8/11',
            status: 'Published',
            status_color: 'success',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标4.1“因果机器学习的泛化性理论”、指标4.2“基于因果关联评价及可解释性框架、基于因果表征的迁移学习方法”，针对现有多源域自适应方法依赖严格假设导致泛化性受限的问题，提出了基于子空间识别的因果机器学习泛化性理论。',
            date: '2023/9/22',
            status: 'Published',
            status_color: 'success',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标4.1“因果机器学习的泛化性理论”、指标4.2“基于因果关联评价及可解释性框架、基于因果表征的迁移学习方法”，针对对抗攻击方法忽视数据因果生成过程、攻击缺乏针对性的问题，提出了融合因果推理与反事实干预的对抗样本生成框架。',
            date: '2024/3/24',
            status: 'Published',
            status_color: 'success',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标1.1“数据驱动的因果网络可识别理论”、指标1.2“跨媒体数据的因果网络构建算法”，针对跨媒体数据传统方法假设过强的问题，提出了因果表征学习的可识别性理论，实现隐因果表征的完全解耦，破解了跨媒体数据的因果表征学习难题。',
            date: '2025/1/20',
            status: 'Accepted',
            status_color: 'primary',
          ...
          },
          {
            ...
            intro_cn:
              '关联研究内容指标4.1“因果机器学习的泛化性理论”、指标4.2“基于因果关联评价及可解释性框架、基于因果表征的迁移学习方法”，针对时间序列领域自适应中现有方法易提取冗余信息、难以捕捉变量间稀疏依赖关系且协变量偏移假设不适用的问题，提出了基于路径签名的时间序列领域自适应方法，通过路径签名变换刻画变量间稀疏依赖并约束跨域依赖一致性，以提升时序特征的判别性与泛化性。',
            date: '2024/7/4',
            status: 'Published',
            status_color: 'success',
        ...
        patents: [
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容3.1“融合环境、动作和激励的强化学习因果模型及其泛化性理论”、3.2“基于因果效应的强化学习策略优化与评估方法”，提出了基于因果特征选择的多无人机避障方法，实现了多无人机系统在未知复杂环境下的自主避障与导航。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
          },
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容4.1“因果机器学习的泛化性理论”、4.2“基于因果关联评价及可解释性框架、基于因果表征的迁移学习方法”，提出了基于因果解耦的道路裂缝检测方法，实现了未知环境下道路裂缝检测的准确性、鲁棒性与跨域泛化能力的提升。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
          },
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容3.1“融合环境、动作和激励的强化学习因果模型及其泛化性理论”、3.2“基于因果效应的强化学习策略优化与评估方法”，提出了基于因果表征学习的无人机集群围捕控制方法及系统，实现了多无人机在未知动态环境中的协同围捕，提升了多无人机系统的泛化能力。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
          },
          {
            ...
            abstract: '',
            intro_cn:
              '关联研究内容3.1“融合环境、动作和激励的强化学习因果模型及其泛化性理论”、3.2“基于因果效应的强化学习策略优化与评估方法”，提出了因果经验回放的多智能体控制方法、装置、设备及介质，实现了多智能体系统决策质量、样本效率和泛化能力的提升。',
            date: '',
            status: 'Published',
            status_color: 'success',
            paperUrl: '',
